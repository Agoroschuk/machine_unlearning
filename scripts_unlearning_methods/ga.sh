...
# New call
# bash scripts_unlearning_methods/ga.sh gpt2_xl 25_dropped 1
...
unlearn_data_id=$3 # 3-й аргумент команд. строки (= 1)
...
save_path=/content/drive/MyDrive/Unlearning/miscellaneous/unlearning_checkpoint/ga/${model}/${percent_blocks_dropped}/${unlearn_data_id}
