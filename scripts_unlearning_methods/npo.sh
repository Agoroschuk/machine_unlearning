...
# bash scripts_unlearning_methods/npo.sh gpt2_xl 0 # здесь важно подать model в том же виде, что и в declare -A
...
model_path=/content/drive/MyDrive/Unlearning/miscellaneous/ft_model_checkpoint/ft_${model}
forget_loss=npo
